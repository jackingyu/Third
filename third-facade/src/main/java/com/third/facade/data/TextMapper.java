...
public class TextMapper {
    ...
    static
    {
        ...
        OrderStatus4Cust.put(
                CoreConstants.OrderStatus.FACTORY_APPROVE.toString(), "工厂已排产");
        OrderStatus4Cust.put(
                CoreConstants.OrderStatus.FACTORY_RECEIPT.toString(), "工厂已排产");
        OrderStatus4Cust.put(
                CoreConstants.OrderStatus.FINICIAL_APPROVE.toString(), "工厂已排产");
        OrderStatus4Cust.put(CoreConstants.OrderStatus.STORE_APPROVE.toString(),
                "工厂已排产");
        OrderStatus4Cust.put(
                CoreConstants.OrderStatus.FACTORY_DELIVERED.toString(),
                "工厂已发货");
        OrderStatus4Cust.put(CoreConstants.OrderStatus.STORE_RECEIPT.toString(),
                "门店已收货");
        OrderStatus4Cust.put(
                CoreConstants.OrderStatus.STORE_DELIVERED.toString(), "已取件");
    }
