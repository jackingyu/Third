...
public class ReservationDataPopulator
		implements Populator<ReservationModel, ReservationData> {
	...
	public void populate(ReservationModel source, ReservationData target)
	{
		...
		target.setChannelText(
				TextMapper.ReservationChannel.get(source.getChannel()));
	}
