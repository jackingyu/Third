...
public class SizeAttributeDataBuilder implements DataBuilder
{
	...
	{
		List<SizeAttributeModel> attributes = JSON.parseArray(sizeAttributesJson, SizeAttributeModel.class);
		attributes.forEach( a ->{	sizeAttributeService.createSizeAttribute(a);});
	}



	public void buildSizeAttribute(final Integer itemCategory, final Integer group, final String name)
	{
