...
public interface ReservationFacade {
	...
	public List<ReservationData> getReservationsForCustomer(
			final String cellphone);

	ListData getReservations(final String storeCode, final String cellphone,
			final String name, final Date fromDate, final Date toDate,
