...
public class DefaultUserFacade implements UserFacade {
    ...
    public String createUser(UserData user)
    {
        ...
        if (CollectionUtils.isNotEmpty(user.getStores()))
        {
        ...
        userModel.setStore(
                storeService.getStoreForCode(user.getStore().getCode()));
    ...
    @Override
    public ListData getUsers(String userId, String userName, String storeCode,
            Integer startIndex, Integer pageSize)
    {
        PaginationSupport result = userService.getUserList(userId, userName,
                storeCode, startIndex, pageSize);
        ListData grid = new ListData();
        grid.setTotal(result.getTotalCount());
    ...
    public String updateUser(UserData userData)
    {
        ...
        user.setStore(
                storeService.getStoreForCode(userData.getStore().getCode()));
    ...
    public void loginSuccess(String userId)
    {
        ...
        if (sessionService.isMobile())
            sessionService.save(CoreConstants.Session.MENU,
                    getMenuDataForMobile());
        else
