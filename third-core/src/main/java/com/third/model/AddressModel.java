...
public class AddressModel  implements java.io.Serializable {
    ...
    public AddressModel(RegionModel region, CityModel city, DistrictModel district, String adr1, String adr2, String tel1, String tel2, Date modificationTime, Date createTime) {
       this.region = region;
       this.city = city;
