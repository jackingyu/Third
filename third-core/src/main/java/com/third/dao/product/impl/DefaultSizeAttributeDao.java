...
public class DefaultSizeAttributeDao extends GenericDAO<SizeAttributeModel, String> implements SizeAttributeDao
{
	private final static String FIND_BY_ITEMCATEGORY_SQL = "from com.third.model.SizeAttributeModel s where s.itemCategory=?";

	@Override
	public List<SizeAttributeModel> findSizeAttributeForItemCategory(Integer itemCategory)
	{
