...
public class DefaultMediaService implements MediaService
{
	...
	@Override
	public String createMedia(String mediaId, String folder, MultipartFile media)
	{
		...
		return mediaStorageStrategy.createMedia(mediaIdWithSuffix, folder, media,basePath);
	}

	public void setMediaStorageStrategy(MediaStorageStrategy mediaStorageStrategy)
	{
