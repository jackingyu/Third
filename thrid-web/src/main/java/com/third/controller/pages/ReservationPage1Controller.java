...
public class ReservationPage1Controller extends AbstractPageController {
	private static final Logger LOG = Logger
			.getLogger(ReservationPage1Controller.class);
	...
	{
		ListData reservations = reservationFacade.getReservations(storeCode,
				cellphone, name, fromDate, toDate, getStartIndex(page, rows),
				rows);
			...
			@RequestParam(value = "comment", required = false) final String comment)
	{
		...
		final String reservationPK = reservationFacade
