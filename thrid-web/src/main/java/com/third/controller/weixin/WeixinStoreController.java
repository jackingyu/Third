...
{
	private static final Logger LOG = Logger.getLogger(WeixinStoreController.class);
	...
	public String getOrderDetail(@RequestParam(value ="code",required=true)final String storeCode,final Model model)
	{
