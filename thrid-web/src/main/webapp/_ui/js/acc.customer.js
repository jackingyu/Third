ACC.customer = {
	create : function() {
		...
		$("#customerForm-cellphone").textbox("readonly",false);
	},
	modify : function(value) {
		...
		$.ajax({
					...
					success : function(data) {
						$("#customerForm-cellphone").textbox("setValue",
								data.cellphone);
						$("#customerForm-name").textbox("setValue", data.name);
						$("#customerForm-QQ").textbox("setValue", data.qq);
						$("#customerForm-email")
								.textbox("setValue", data.email);
						$("#customerForm-birthday").datebox("setValue",
								data.birthday);
						$("#customerForm-weddingdate").datebox("setValue",
								data.weddingdate);

						$("#customerForm-region").combobox("setValue",
								data.address.region.isoCode);
						$("#customerForm-city").combobox("setValue",
								data.address.city.isoCode);
						$("#customerForm-adr1").textbox("setValue",
								data.address.adr1);

						$("#customerForm-source").combobox("setValue",
								data.source.pk);

						$("#customerForm-comment").textbox("setValue",
								data.comment);
