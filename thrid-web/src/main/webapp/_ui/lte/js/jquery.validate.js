...
$.extend( $.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format( "最多可录入{0}个汉字." ),
		minlength: $.validator.format( "最多可录入{0}个汉字." ),
	...
	methods: {
		...
		required: function( value, element, param ) {
			...
			if ( this.checkable( element ) ) {
				return this.getLength( trimValue, element ) > 0;
			}
		...
		paramMax: function( value, element, param ) {
		...
		paramMin: function( value, element, param ) {
