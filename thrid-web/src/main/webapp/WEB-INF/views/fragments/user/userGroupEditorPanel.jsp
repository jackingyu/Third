...
<!-- 用于 usergrouplistpage 编辑usergroup -->
<div id="userGroupPanel" class="easyui-panel" style="width: 600px;"
	title="<spring:message code="usergrouppanel.title"/>">
	<form id="userGroupForm" method="post">
		...
		<table id="roleListGrid"
			style="margin: 20px; width: 400px; height: 200px"
		...
		<div class="form-submit1">
			<input id="userGroupPk" name="pk" type="hidden" />
...
<div id="roleSelector" closed="true" class="easyui-dialog">
	...
	<div>
		<a id="selectRolesLink" href="#" style="float: right; margin: 5px"
			onclick="ACC.usergroup.selectRoles();"><spring:message
				code="text.select"></spring:message></a>
	</div>
</div>
