...
<template:page>
	<jsp:attribute name="pageScripts">
	   <script src="${lteResourcePath}/js/acc.sourcelist.js"></script>
    ...
    <section class="content-header">
      ...
      <a onclick="ACC.sourcelist.query()" class="btn btn-app">
          <i class="fa fa-search"></i>  <spring:message code="lte.search"></spring:message>
       </a>
      </div>
      <div class="col-lg-1 col-md-1">
      <a class="btn btn-app" data-toggle="modal" data-target="#sourcePanel">
