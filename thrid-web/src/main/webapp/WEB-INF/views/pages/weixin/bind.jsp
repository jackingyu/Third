...
<body>
	...
	<form id="bindform" class="form-horizontal" role="form" action="${pageContext.request.contextPath}/wx/bind" method="post">
		<div class="container wx_container" style="margin-top:20px">
			<div class="row wx_row">
				...
				<div class="col-md-8  col-xs-8 col-sm-8 col-lg-8">
					<input id="phone" name="phone" type="text" class="wx_formcontrol" placeholder="手机号" value="${requestScope.phone}" />
				</div>
			</div>
			<div class="row wx_row">
				<div class="col-md-1 col-xs-1 col-sm-1 col-lg-1">
				...
				<div class="col-md-4 col-xs-4 col-sm-4 col-lg-4">
					<input id="vcode" name="vcode" type="text" class="wx_formcontrol" placeholder="验证码">
				</div>
			...
			<div class="row wx_button_row">
				<button id="submit_btn" type="button" class="btn btn-default btn_submit">会员绑定</button>
			</div>
		</div>
		<div class="panel-heading">
			<p>温馨提示</p>
			<p>1. 输入您留在铂玛门店的手机号，铂玛会将自动将您的微信和您在铂玛会员绑定。方便您实时查询订单状态，预约量身。如果您还不是铂玛会员，请移步<a href="${pageContext.request.contextPath}/wx/register">加入铂玛会员计划</a>。</p>
			<p>2. 根据省份，城市，地区不同，一般会在5秒-60秒内收到验证码。如未收到，您可以在60秒后重新获取。</p>
		</div>
	</form>
