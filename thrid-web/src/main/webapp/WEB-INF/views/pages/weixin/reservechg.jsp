...
<% ReservationModel rev = (ReservationModel)request.getAttribute("reserveModel"); %>
	...
	<form id="revform" class="form-horizontal" role="form" action="${pageContext.request.contextPath}/wx/revchange" method="post">
		<div class="container wx_container">
		
			<input id="id" name="id" type="hidden" class="wx_formcontrol" placeholder="ID" value="<%=rev.getId() %>" />
			...
			<div class="row wx_row">
				...
				<div class="col-md-8  col-xs-8 col-sm-8 col-lg-8">
					<input id="name" name="name" type="text" class="wx_formcontrol" placeholder="中文名" value="<%=rev.getName() %>" />
				</div>
			</div>
			<div class="row wx_row">
				<div class="col-md-1 col-xs-1 col-sm-1 col-lg-1">
				...
				<div class="col-md-8  col-xs-8 col-sm-8 col-lg-8">
					<input id="phone" name="phone" type="text" class="wx_formcontrol" placeholder="手机号" value="<%=rev.getPhone() %>" />
				</div>
			</div>
			<div class="row wx_row">
				<div class="col-md-1 col-xs-1 col-sm-1 col-lg-1">
				...
				<div class="col-md-8  col-xs-8 col-sm-8 col-lg-8">
					<input type="text" class="wx_formcontrol" value="<%=(new SimpleDateFormat("yyyy-MM-dd")).format(rev.getDate())%>"
	...
	<script type="text/javascript">
		...
		for(var i = 0; i < cityStores[city].length; i++) {
			if( cityStores[city][i].id == '<%=rev.getStore().getId() %>' ){
				$("#store_select").append("<option selected=\"selected\" value='" + cityStores[city][i].id + "'>" + cityStores[city][i].storeName + "</option>");
