	...
	<div class="box-body">
		<div class="row">
			...
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12 ">
				...
				<input readonly="readonly"  name="orderCode" value="${orderEntry.orderCode}" class="form-control required" placeholder="" type="text">
			</div>
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12 ">
				<label><spring:message code="lte.orderentry.code"></spring:message></label>
				<input id="orderEntryPK" value="${orderEntry.pk}" name="entryPK" class="form-control required" placeholder="" type="text">
			</div>
		</div>
		<div class="row">
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12 ">
			...
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12 ">
				<label><spring:message code="lte.orderentry.customername"></spring:message></label>
		         <input value="${orderEntry.customerName }" name="customerName" class="form-control" placeholder="" type="text">
			</div>
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12 ">
				<label><spring:message code="lte.orderentry.style"></spring:message></label>
		         <input value="${orderEntry.style}" name="style" class="form-control" placeholder="" type="text">
			</div>
		</div>
		<div class="row">
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12 ">
				<label><spring:message code="lte.orderentry.designer"></spring:message></label>
				<input  name="designer" class="form-control required" placeholder="" type="text" value="${orderEntry.designer}">
			</div>
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12 ">
		...
		<div class="row">
			<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                ...
                <input name="productTitle" value="${orderEntry.productTitle}" class="form-control" placeholder="" type="text">
			</div>
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
				<label><spring:message code="lte.orderentry.quantity"></spring:message></label>
				<input name="quantity" value="${orderEntry.quantity}" class="form-control" placeholder="" type="text">
			</div>
		</div>
		<div class="row">
...
<div class="box">
	...
	<div class="box-body">
	  <c:forEach items="${orderEntry.sizeDatas}" var="sizeData">
	    <sales:sizeDataColumn sizeDatas="${sizeData.value.attributes}" title="${sizeData.value.groupText}"/>
	  </c:forEach>
	</div>
</div>
</c:if>
...
<button type="submit" class="createSizeOrderBtn btn btn-primary hidden-md hidden-lg "><spring:message code="lte.save"></spring:message></button>
